...
export function AboutProgamm() {
    ...
    return (
        <section className="about" id='program'>
            ...
            <div className="about__text">
                <h4 className="about__title second-title">What is my Programm do?</h4>
                <p className="about__paragr paragraph">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officia nobis quo, odio iusto laboriosam in, saepe quia iure ad ex tempora illum cum incidunt pariatur officiis nihil autem libero itaque.</p>
